...
class AppColorTokens extends ThemeExtension<AppColorTokens> {
  ...
  static const light = AppColorTokens(
    ...
    textOnGlass: Color(0xFF0F172A),
    textOnGlassMuted: Color(0xFF475569),
    backgroundBase: Color(0xFFF7F9FE),
    backgroundSubtle: Color(0xFFEFF4FC),
    ...
    cardBackgroundMuted: Color(0x99F6F8FC),
    cardBorder: Color(0x66FFFFFF),
    cardShadow: Color(0x240F172A),
    inputBackground: Color(0xCCFFFFFF),
    inputBorder: Color(0x66CBD5E1),
    inputFocusedBorder: Color(0xFF2F6BFF),
    inputErrorBorder: Color(0xFFD92D20),
    inputPlaceholder: Color(0xFF64748B),
    inputCursor: Color(0xFF2F6BFF),
    ...
    infoContainer: Color(0xFFD8F1FF),
    ...
    premiumGradientStart: Color(0xFF2F6BFF),
    premiumGradientEnd: Color(0xFFB96CFF),
    debug: Color(0xFF7C3AED),
    mock: Color(0xFF0EA5E9),
    updateRequired: Color(0xFFD92D20),
    updateOptional: Color(0xFF2F6BFF),
  );

  static const dark = AppColorTokens(
    textPrimary: Color(0xFFE8ECF3),
    textSecondary: Color(0xFFC3CBD8),
    textTertiary: Color(0xFF98A3B5),
    textDisabled: Color(0xFF687385),
    textOnGlass: Color(0xFFF3F6FB),
    textOnGlassMuted: Color(0xFFC3CBD8),
    backgroundBase: Color(0xFF0F1724),
    backgroundSubtle: Color(0xFF121A2A),
    backgroundElevated: Color(0xFF182235),
    backgroundFloating: Color(0xE61A263A),
    backgroundOverlay: Color(0x660A1020),
    cardBackground: Color(0x8C1B263A),
    cardBackgroundMuted: Color(0x66192335),
    cardBorder: Color(0x33FFFFFF),
    cardShadow: Color(0x66000000),
    inputBackground: Color(0x99192335),
    inputBorder: Color(0x664A5870),
    inputFocusedBorder: Color(0xFFAEC4FF),
    inputErrorBorder: Color(0xFFFFB4AB),
    inputPlaceholder: Color(0xFF98A3B5),
    inputCursor: Color(0xFFAEC4FF),
    ...
    infoContainer: Color(0xFF0B3B52),
    onInfo: Color(0xFF06283A),
    destructive: Color(0xFFFFB4AB),
    destructiveContainer: Color(0xFF5F1612),
    onDestructive: Color(0xFF3F0806),
    link: Color(0xFFAEC4FF),
    focusRing: Color(0x66AEC4FF),
    selection: Color(0x33AEC4FF),
    pressedOverlay: Color(0x24FFFFFF),
    hoverOverlay: Color(0x1AFFFFFF),
    disabledBackground: Color(0xFF2A3446),
    disabledForeground: Color(0xFF687385),
    divider: Color(0x663C465B),
    overlay: Color(0x99000000),
    modalBarrier: Color(0xA6000000),
    scrimSoft: Color(0x66000000),
    scrimStrong: Color(0xCC000000),
    premium: Color(0xFFD8B4FE),
    premiumGradientStart: Color(0xFFAEC4FF),
    premiumGradientEnd: Color(0xFFE9D5FF),
    debug: Color(0xFFC084FC),
    mock: Color(0xFF7DD3FC),
    updateRequired: Color(0xFFFFB4AB),
    updateOptional: Color(0xFFAEC4FF),
  );
